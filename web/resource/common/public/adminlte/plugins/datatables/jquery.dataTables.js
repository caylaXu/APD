...
(/** @lends <global> */function( $ ) {
	...
	function _fnAjaxUpdateDraw ( settings, json )
	{
		...
		var compat = function ( old, modern ) {
			var convert = eval("json."+modern);
			return json[old] !== undefined ? json[old] : convert;
		};
		var data = _fnAjaxDataSrc( settings, json );
		var draw            = compat( 'draw',           settings.ajax.accept.draw );
		var recordsTotal    = compat( 'records',        settings.ajax.accept.records );
