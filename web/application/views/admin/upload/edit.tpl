	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
				...
				<!-- form start -->
				<form role="form" action="/admin/upload/edit" method="post">
					<div class="box-body">
						<div class="form-group">
							{if isset($errors)}
								{foreach $errors as $error}
									<tr style="text-align: center;color: red"><td colspan="2">{$error}</td></tr>
								{/foreach}
							{/if}
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="">目标版本号：</label>
							<input type="text" class="form-control" name="target_version_id" placeholder=""
								   value="{if isset($data['TargetVersionId'])}{$data['TargetVersionId']}{/if}">
						</div>
					</div><!-- /.box-body -->
